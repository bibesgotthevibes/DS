...
int main(int argc, char** argv) {
    cout << "=== Client 1 Starting (Distributed) ===" << endl;
    ...
    cout << "--> Final Answer: " << (result_is_2 ? "True" : "False") << endl;
    this_thread::sleep_for(chrono::milliseconds(500));

    cout << "\n=== Test 3: Query matching ===" << endl;
    bool result_m_2 = client.QueryMatching(2);
    cout << "--> Final Answer: " << (result_m_2 ? "True" : "False") << endl;
    this_thread::sleep_for(chrono::milliseconds(500));
    ...
    cout << "--> Final Answer (IS): " << (result_is_5 ? "True" : "False") << endl;
    this_thread::sleep_for(chrono::milliseconds(500));
    bool result_m_4 = client.QueryMatching(4);
    cout << "--> Final Answer (M): " << (result_m_4 ? "True" : "False") << endl;
    this_thread::sleep_for(chrono::milliseconds(500));
    ...
    cout << "--> Final Answer (IS): " << (result_is_1 ? "True" : "False") << endl;
    this_thread::sleep_for(chrono::milliseconds(500));
    bool result_m_2_final =client.QueryMatching(2);
    cout << "--> Final Answer (Matching): " << (result_m_2_final ? "True" : "False") << endl;
