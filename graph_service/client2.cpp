...
int main(int argc, char** argv) {
    ...
    client.QueryIndependentSet(4);
    this_thread::sleep_for(chrono::milliseconds(500));
    client.QueryMatching(4);
    this_thread::sleep_for(chrono::milliseconds(500));
    ...
    client.QueryIndependentSet(7);
    this_thread::sleep_for(chrono::milliseconds(500));
    client.QueryMatching(3);
    this_thread::sleep_for(chrono::milliseconds(500));

    cout << "\n=== Test 8: Stress test with large queries ===" << endl;
    client.QueryIndependentSet(10);
    this_thread::sleep_for(chrono::milliseconds(500));
    client.QueryMatching(8);
